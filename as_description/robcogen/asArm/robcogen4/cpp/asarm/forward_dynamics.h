#ifndef IIT_ROBOT_ASARM_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_ASARM_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot asArm.
 *
...
inline void ForwardDynamics<TRAIT>::setJointStatus(const JointState& q) const {
    (motionTransforms-> fr_xarmlink1_X_fr_base_link)(q);
