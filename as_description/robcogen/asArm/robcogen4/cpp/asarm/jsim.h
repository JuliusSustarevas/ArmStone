#ifndef IIT_ASARM_JSIM_H_
#define IIT_ASARM_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot asArm.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::asArm::tpl::JointState<typename TRAIT::Scalar>, 12, 12, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::asArm::tpl::JointState<typename TRAIT::Scalar>, 12, 12, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::asArm::tpl::JointState<Scalar> JointState;
        typedef iit::rbd::Core<Scalar> CoreS;
        typedef typename Base::Index Index;
        typedef typename iit::rbd::PlainMatrix<Scalar, 12, 12> MatrixType;
        /** The type of the F sub-block of the floating-base JSIM */
        typedef const Eigen::Block<const MatrixType,6,6> BlockF_t;
        /** The type of the fixed-base sub-block of the JSIM */
        typedef const Eigen::Block<const MatrixType,6,6> BlockFixedBase_t;
        typedef InertiaProperties<TRAIT> IProperties;
        typedef iit::asArm::tpl::ForceTransforms<TRAIT> FTransforms;
